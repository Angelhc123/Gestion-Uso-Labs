...
// Paleta de colores (puede ser importada)
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Text('Crear Usuario de Soporte', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: textOnDark)),
            ...
            child: Column(
              children: [
                TextFormField(
                  ...
                  decoration: _inputDecoration('Email de Soporte', prefixIcon: Icons.email_outlined),
          ...
          Text('Buscar y Gestionar Usuario por UID', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: textOnDark)),
          const SizedBox(height: 10),
          Row(
              children: [
                  Expanded(
                      child: TextFormField(
                          ...
                          decoration: _inputDecoration('UID del Usuario', prefixIcon: Icons.search),
                          style: const TextStyle(color: textOnDark),
                      ),
                  ),
            ...
            Card(
              ...
              child: ListTile(
                ...
                trailing: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(backgroundColor: _searchedUser!.isDisabled ? Colors.green.shade400 : Colors.red.shade400),
                  child: Text(_searchedUser!.isDisabled ? 'Habilitar' : 'Deshabilitar', style: const TextStyle(color: Colors.white)),
                ),
                isThreeLine: true,
              ),
            ),
          ...
          if (_feedbackMessage != null) 
            Padding(
              ...
              child: Text(_feedbackMessage!, 
                style: TextStyle(color: _feedbackMessage!.toLowerCase().contains('error') ? Colors.redAccent : Colors.greenAccent, fontWeight: FontWeight.bold)
              ),
            ),
          const SizedBox(height: 25),
          Row(
          ...
          StreamBuilder<List<UserModel>>(
            ...
            builder: (context, snapshot) {
              ...
              if (snapshot.hasError) {
                return Center(child: Text('Error al cargar usuarios: ${snapshot.error}', style: const TextStyle(color: Colors.redAccent)));
              }
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      leading: Icon(user.isDisabled ? Icons.person_off_outlined : Icons.person_outline, color: accentPurple),
                      ...
                      trailing: ElevatedButton(
                        onPressed: () => _toggleUserStatus(user.uid, user.isDisabled),
                        style: ElevatedButton.styleFrom(backgroundColor: user.isDisabled ? Colors.green.shade400 : Colors.red.shade400),
                        child: Text(user.isDisabled ? 'Habilitar' : 'Deshabilitar', style: const TextStyle(color: Colors.white)),
                      ),
                      isThreeLine: true,
                    ),
                  );
